...
const Hero: React.FC = () => {
  ...
  const downloadResume = () => {
    ...
    link.href = '/resume/Mounishwaran_A_Resume.pdf';
    link.download = 'Mounishwaran_A_Resume.pdf';
    link.click();
  };
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          {/* Social Links - Left Side (Desktop Only) */}
          ...
          {/* Hero Image - Mobile First, Desktop Right */}
          <motion.div
          ...
          >
            <div className="relative">
              <motion.div
                className="w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-2xl bg-gradient-to-br from-warm-yellow to-golden-yellow p-1"
          ...
          >
            <motion.h1
              className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-dark-gray mb-4 font-space-grotesk whitespace-nowrap"
            ...
            {/* Social Links - Mobile (Below Buttons) */}
            <div className="lg:hidden flex flex-row gap-4 justify-center mt-8">
              {socialLinks.map((social, index) => (
                <motion.a
                  key={social.name}
                  href={social.url}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full bg-white shadow-lg flex items-center justify-center hover:bg-warm-yellow hover:text-white transition-all duration-300 group"
